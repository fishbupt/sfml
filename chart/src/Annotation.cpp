...
namespace Graph
{
    ...
    Annotation::Annotation(OrbitCamera^ camera)
    {
        _camera = camera;
        FontSize = 13;
    ...
    void Annotation::Draw(IntPtr target)
    {
        Draw((sf::RenderTarget*)target.ToPointer(), sf::RenderStates::Default);
    }
    ...
    void Annotation::PlotXAnnotation(const sf::Transform& transform)
    {
        ...
        PlotAxisMin(_textBlocks[TextXAxisMin], screenX[0], XAxisMin, angle);

        PlotAxisMax(_textBlocks[TextXAxisMax], screenX[1], XAxisMax, angle);
    }
    ...
    void Annotation::PlotYAnnotation(const sf::Transform& transform)
    {
        ...
        minText->Text = FormatAxisValue(YAxisMin);
        ...
        maxText->Text = FormatAxisValue(YAxisMax);
    ...
    void Annotation::PlotZAnnotation(const sf::Transform& transform)
    {
        ...
        PlotAxisMin(_textBlocks[TextZAxisMin], screenZ[0], ZAxisMin, angle);

        PlotAxisMax(_textBlocks[TextZAxisMax], screenZ[1], ZAxisMax, angle);
    }
} // namespace Xsa
} // namespace Presentation
} // namespace Graph
