...
///
////////////////////////////////////////////////////////////
class SFML_GRAPHICS_API Camera : public View
{
public :
    ...
    /// \code
    /// sf::Vector3f scale = camera.getScale();
...
/// \ingroup graphics
///
/// sf::Camera defines a camera in the 3D scene. This is a
/// very powerful concept: you can move, rotate or zoom
/// the entire scene without altering the way that your
/// drawable objects are drawn.
///
/// An sf::Camera is much like a camera in real life. It has
...
///
/// Because sf::Camera inherits from sf::View, its viewport
...
///
/// sf::Camera can be combined with sf::View to render a scene
/// using a 3D perspective and then to render 2D elements such as
/// text or a GUI using an sf::View. Just switch back and forth
...
/// camera.setViewport(sf::FloatRect(0.f, 0.f, 1.f, 0.5f));
///
/// // Apply it
...
///
/// \see sf::View, sf::RenderWindow, sf::RenderTexture
///
////////////////////////////////////////////////////////////
